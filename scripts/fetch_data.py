...
for el in els:
    ...
    f = {"type": "Feature", "geometry": {"type": "Point", "coordinates": [round(lo, 6), round(la, 6)]},
         "properties": {k: v for k, v in tags.items() if k in ["name", "brand", "operator", "opening_hours", "fuel:cng", "payment:credit_cards", "payment:debit_cards", "phone", "compressed_gas", "shop"]}}
